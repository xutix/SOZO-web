...
function CasesPage() {
  ...
  return <PageShell active="cases" title="服务与案例">
    <PageHero index="04" eyebrow="SERVICES & FIELD WORK" className="page-hero--cases page-hero--immersive" title={<>从原型研发<br /><span>走进展会现场</span></>} description="面向企业、学校、科技馆与活动方，提供硬件原型、FPV 技术、互动展示与创客课程服务。" image="expo-booth.jpg" />
...
function AboutPage() {
  return <PageShell active="about" title="关于索卓科技">
    <PageHero index="05" eyebrow="ABOUT SOZO" className="page-hero--about" title={<>产品不在 PPT<br /><span>而在工程现场</span></>} description="产品是桌面上的电路、飞行中的姿态、展会现场的互动，以及用户真正愿意上手的体验。" image="soldering.jpg" />
