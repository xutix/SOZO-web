...
export function ProductsPage() {
  return <PageShell active="products" title="产品方向">
    <PageHero index="01" eyebrow="PRODUCT DIRECTIONS" variant="image" page="products" title={<>以产品为主线<br /><span>把工程能力落地</span></>} description="SOZO Dock 是当前阶段的核心产品；FPV、工程工具和创客教育，是支撑这款产品与后续生态的真实工程能力。" image="tool-workstation.jpg" />
