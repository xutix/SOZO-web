...
export function AboutPage() {
  return <PageShell active="about" title="关于索卓科技">
    <PageHero index="05" eyebrow="ABOUT SOZO" className="page-hero--about page-hero--about-video" title={<>把工程变成<br /><span>可体验的现场</span></>} description="索卓科技的核心不是同时做很多东西，而是把硬件、飞行和创客实践整理成可感知、可操作、可展示的产品体验。" image="soldering.jpg" video="about-standing-desk.mp4" videoPlaybackRate={0.65} />
